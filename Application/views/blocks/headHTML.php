...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?php echo getPathImg('logo.png'); ?>">
    ...
    <script src="<?php echo getPathJS('responsive.js'); ?>"></script>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo getPathCSS('responsive.css'); ?>">
