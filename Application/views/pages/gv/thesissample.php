<div class="content-wrapper">
    ...
    <div class="main-content">
        ...
        <div class="wrapper text-end">
            <select class="form-select d-inline-flex mb-3" aria-label="Default select example"  id="selectListCategory">
        ...
        <div class="thesis-sample-add mb-20 ">
            ...
            <div class="text-center">
                <button type="button" class="btn btn-primary btn-warning btn-add" data-bs-toggle="modal" data-bs-target="#add-thesis-sample"><i class="fas fa-plus-circle pd-4"></i>Thêm mới</button>
            </div>
            <!-- Modal -->
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" onclick="addExampleThesis();" class="btn btn-primary btn-warning">Lưu</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="delete-thesis" tabindex="-1" aria-labelledby="delete-thesis-Label" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary btn-fix " data-bs-dismiss="modal">Đóng</button>
                            <button type="button" onclick="deleteExampleThesis();" data-bs-dismiss="modal" class="btn btn-primary btn-warning">Xóa</button>
                        </div>
                    </div>
                </div>
            </div>
