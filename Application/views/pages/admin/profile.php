<div class="content-wrapper account-update" style="margin: 15px">
    <div class="heading">
        ...
        <div class="form-wrapper">
            <form method="post">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <button type="button" onclick="updateUser();" class="btn btn-info btn-submit" id="btnSubmitInfor">Lưu thay đổi</button>
                    </div>
                </div>
            </form>
        </div>
