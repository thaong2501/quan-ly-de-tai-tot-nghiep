<div class="admin-main">
    ...
    <div class="admin-main-content">
        ...
        <div class="text-center">
            <button type="button" class="btn btn-info btn-add" data-bs-toggle="modal" data-bs-target="#add-thesis-topic"><i class="fas fa-plus-circle pd-4" ></i>Thêm mảng đề tài</button>
        </div>
