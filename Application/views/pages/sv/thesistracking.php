        ...
        <table id="tbThesisTracking" class="table table-striped table-bordered">
            <thead>
                <tr>
                    ...
                    <th scope="col" id="thBtnThesis">Thao tác</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                        ...
                                        <form>
                                            <fieldset >
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="fixTitleThesis" class="form-control">
                                                </div>
                                                <div class="mb-3">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" onclick="updateRegistedThesis();" class="btn btn-primary btn-warning">Lưu</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal fade" id="delete-thesis" tabindex="-1" aria-labelledby="delete-thesis-Label" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary btn-fix " data-bs-dismiss="modal">Đóng</button>
                                        <button type="button" onclick="deleteThesis();" class="btn btn-primary btn-warning" data-bs-dismiss="modal">Xóa</button>
                                    </div>
                                </div>
                            </div>
                        </div>
